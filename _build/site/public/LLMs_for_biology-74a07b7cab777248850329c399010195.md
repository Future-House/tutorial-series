...
Instead of processing natural language, these models can also be trained on biological sequences such as proteins, DNA, or RNA. Recent advances in model architectures and hardware have boosted the application of AI in biology. 
