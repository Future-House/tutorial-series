...
By performing this task across millions or billions of sequences, the model gradually learns patterns in the data. In natural language, this includes grammar and semantic relationships between words [@gu2021domain]. In biological sequences, the model may learn signals related to protein structure, evolutionary constraints, and functional motifs. This objective is commonly used in autoregressive language models, such as GPT-style models.
