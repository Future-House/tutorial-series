...
During pre-training, language models learn by solving prediction tasks known as training objectives. These objectives define what the model is asked to predict from the data and provide the signal used to update the model’s parameters.

There are two common objectives used to train language models.
