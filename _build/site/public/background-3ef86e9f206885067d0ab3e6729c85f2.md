# 1.1 AI for Scientists: Why does it matter?

***This page provides  literature background on AI. You may skip to the next chapters to see more hands-on applications.***

From genome sequencing and single-cell transcriptomics to high-content imaging and protein structure prediction, modern biology generates data at a scale and complexity that exceeds traditional analytical approaches. Artificial intelligence (AI) — particularly machine learning — has emerged as a powerful set of tools for extracting patterns, generating hypotheses, and accelerating discovery from biological data. 

But AI is not magic. It is a collection of mathematical models, statistical principles, and computational tools that must be understood, evaluated, and applied carefully — especially in high-stakes scientific contexts.

In this course, we’ll start by building a foundation. We’ll begin with the history and basic ideas behind AI—how the field started, how it evolved, and the key concepts that shape modern systems today, such as models, learning algorithms, and AI agents. Understanding this background helps demystify AI and gives us the tools to think critically about how these systems work.
