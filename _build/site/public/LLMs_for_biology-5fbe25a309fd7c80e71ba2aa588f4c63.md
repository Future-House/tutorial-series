...
Language models are typically trained using a strategy known as [self-supervised learning](https://www.ibm.com/think/topics/self-supervised-learning).

By training on millions or billions of sequences (protein or natural language), language models learn rich representations of biological sequences.
...
By training on millions or billions of sequences instead of natural language, these models learn rich representations of biological sequences. For example, if a foundational model is trained only on protein sequences, then these are called Protein Language Models (PLMs). 

Remarkably, these models often learn biological properties that were never explicitly provided during training.
